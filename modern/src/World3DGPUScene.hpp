...
namespace monopoly::engine
{
    ...
    // Final portable scene-data boundary before an SDL_GPU graphics pipeline.
    // It preserves sequencer traversal and per-mesh batch order; no sorting,
    // shader choice, texture upload or draw call is invented here.
