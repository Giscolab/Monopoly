...
- suite complete depuis ce build neuf : **66/66 suites passees**, zero echec ;
...
1. Continuer `UDIBar` apres score strip, bank hover et selection joueur/banque maintenant
   prouves : porter les consommateurs encore purement sequence, puis conserver cash/noms
   comme donnees jusqu au backend minimal fonts/surfaces; ne pas inventer de rendu texte
   ni de SFX avant leurs services portables.
