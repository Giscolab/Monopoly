...
1. Continuer `UDIBar` apres score strip et bank hover maintenant prouves : raccorder
   la selection joueur/banque de la barre et les consommateurs encore purement sequence,
   puis conserver cash/noms comme donnees jusqu au backend minimal fonts/surfaces; ne pas
   inventer de rendu texte ni de SFX avant leurs services portables.
