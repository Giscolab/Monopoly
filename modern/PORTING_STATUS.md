...
- suite complete depuis ce build neuf : **79/79 suites passees**, zero echec ;
...
1. Continuer `UDTrade` dans l ordre source : `movingcard`, les playbacks statiques jail/future/immunity et le popup cash autonome sont fermes; auditer puis porter les dialogues Future/Immunity et panneaux encore manquants, en separant les sequences DAT autonomes des surfaces runtime dependantes des fonts. Conserver texte/fonts/audio explicitement differes tant que leurs backends portables ne sont pas disponibles. Le chemin autonome `UDAuct` reste ferme hors surfaces texte et audio/voix Pennybags.
