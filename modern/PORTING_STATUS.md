...
4. Poursuivre la Phase D en priorisant `UDPsel -> UDPieces -> UDAuct -> UDTrade -> UDOpts`; revenir a UDIBar lorsque ces modules ou un backend fonts/surfaces debloquent ses derniers consommateurs, et reporter AI, audio/voice et video tant qu ils ne debloquent pas un chemin plus prioritaire.
