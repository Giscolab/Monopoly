...
- suite complete depuis ce build neuf : **68/68 suites passees**, zero echec ;
...
1. Continuer `UDBoard` dans l ordre source apres ownership/mortgage : raccorder le backdrop/plateau 2D `DAT_BOARD/DAT_BOARD2` et son remplacement exact selon vue/camera/mode, puis les hotspots/consommateurs sequence atteignables sans inventer de surfaces dynamiques.
