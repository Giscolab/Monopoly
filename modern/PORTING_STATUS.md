...
- suite complete depuis ce build neuf : **65/65 suites passees**, zero echec ;
...
1. Continuer `UDIBar` apres Pressed, deeds et cartes maintenant prouves : porter les
   score boxes/cash et le bank hover a partir des notifications deja routees, puis
   separer les donnees texte/noms de leur futur rendu sans ouvrir prematurement le
   chantier fonts/surfaces dynamiques.
