...
- reconstruction **clean-first complete** de `modern/build-phase-c`, code de
  ...
  `MonopolyGPU3DCore` ;
- suite complete depuis ce build neuf : **52/52 suites passees**, zero echec ;
- trace conservee dans le build ignore sous
  `modern/build-phase-c/ctest-full-20260906-dice-camera-final.log` ;
