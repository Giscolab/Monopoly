...
2. Continuer la boucle AI dans l ordre retail : notifications secondaires restantes et re-tirage semi-important par partenaire sans surconsommer la sequence `rand()`. Les chemins CardSeen/configuration/resync/off-board sont maintenant raccordes mais restent a qualifier.
