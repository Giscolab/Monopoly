...
1. Continuer `UDBoard` dans l ordre source apres backdrop + ownership/mortgage : porter les hotspots/input plateau et les consommateurs sequence qui en dependent, puis la composition ville/systeme seulement lorsque ses assets/callers sont prouves.
