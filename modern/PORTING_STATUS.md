...
1. Continuer `UDPsel` dans l ordre source sur `CustomizeRules`: porter d abord les controles/regles et leurs transactions GameOptions sans inventer le rendu texte/font; UDIBar reste borne aux consommateurs autonomes deja couverts et ne doit etre rouvert que lorsqu UDStats/UDTrade/UDOpts ou un backend fonts/surfaces debloquent un chemin reel.
